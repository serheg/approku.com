        ...
        pwaInstallButton.addEventListener('click', (e) => {
          ...
          deferredPrompt.userChoice.then((choiceResult) => {
            if (choiceResult.outcome === 'accepted') {
              ...
              window.location.replace("https://approku.com/click.php?key=3xh8fp3ocf3kh5l10m34&bid_id={CONVERSION_ID}");
            } else {
...
self.addEventListener('DOMContentLoaded', () => {
  ...
  if(displayMode == 'standalone' || displayMode == 'standalone-ios'){
    ...
    self.location.replace("https://approku.com/click.php?key=3xh8fp3ocf3kh5l10m34&bid_id={CONVERSION_ID}");
  }
});
